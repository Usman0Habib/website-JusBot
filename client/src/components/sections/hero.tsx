...
export default function Hero() {
  return (
    <section className="relative pt-32 pb-20 px-4 overflow-hidden gradient-bg">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mt-16 fade-in-up" style={{ animationDelay: "0.4s" }}>
            <div className="relative max-w-3xl mx-auto">
              {/* Phone mockup */}
              <div className="relative mx-auto w-80 h-96 bg-white rounded-3xl shadow-2xl p-4 float-animation">
                <div className="w-full h-full bg-gradient-to-br from-primary/10 to-secondary/10 rounded-2xl flex items-center justify-center">
                  <MessageSquare className="w-32 h-32 text-primary/30" />
                </div>
              </div>
              
              {/* Floating legal icons */}
              <div className="absolute top-10 -left-10 w-20 h-20 bg-white rounded-2xl shadow-xl p-4 float-animation" style={{ animationDelay: "0.5s" }}>
              ...
              <div className="absolute top-20 -right-10 w-24 h-24 bg-secondary/20 rounded-2xl shadow-xl p-5 float-animation" style={{ animationDelay: "1s" }}>
